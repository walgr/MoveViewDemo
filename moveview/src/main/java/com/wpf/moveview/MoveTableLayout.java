...
public class MoveTableLayout extends TableLayout implements
    ...
    public MoveTableLayout(Context context) {
        this(context,null);
    }

    public MoveTableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
