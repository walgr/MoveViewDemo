...
public class MoveGridLayout extends GridLayout implements
    ...
    public MoveGridLayout(Context context) {
        this(context,null);
    }

    public MoveGridLayout(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public MoveGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
